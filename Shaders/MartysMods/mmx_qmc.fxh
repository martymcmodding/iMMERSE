...
float roberts1(in uint idx) {return roberts1(n, 0.5);}
float roberts2(in uint idx) {return roberts2(n, 0.5.xx);}
float roberts3(in uint idx) {return roberts3(n, 0.5.xxx);}
